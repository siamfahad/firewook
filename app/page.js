...
const ourStoryCards = [
  {
    ...
    shortDescription: "Driven by a deep love for authentic Chinese cuisine and innovative culinary techniques.",
    longDescription: "Our journey began with a simple yet profound desire: to share the electrifying and nuanced flavors of modern Chinese cooking with the vibrant community of Toronto. Every dish we craft is a testament to our unwavering passion for culinary excellence.",
    color: "#181e28",
  },
  {
    id: 2,
    title: "Fresh Ingredients",
    shortDescription: "Committed to sourcing the highest quality, freshest ingredients from local and international markets.",
    longDescription: "We believe that exceptional cuisine starts with exceptional ingredients. That's why we meticulously select the freshest produce, premium meats, and authentic spices, ensuring that every bite is bursting with natural flavor and goodness.",
    color: "#181e28",
  },
  {
    id: 3,
    title: "Fast & Convenient",
    shortDescription: "Delivering delicious and satisfying meals to your doorstep with speed and convenience.",
    longDescription: "In today's fast-paced world, we understand the need for convenience without compromising on quality. Our efficient takeout and delivery services are designed to bring the Firewook experience right to your home, quickly and with a smile.",
    color: "#181e28",
  },
];
...
const testimonials = [
  {
    ...
    username: "Sarah M.",
    rating: 5,
    text: "The Spicy Dragon Noodles were incredible! Perfect balance of flavor and heat. Best takeout I've had in ages.",
  },
  {
    id: 2,
    username: "John B.",
    rating: 4,
    text: "Fast delivery and the food was so fresh. The Kung Pao Chicken was packed with flavor. Highly recommend Firewook!",
  },
  {
    id: 3,
    username: "Emily K.",
    rating: 5,
    text: "Amazing food and great service. The online ordering was easy, and the food arrived hot and on time. Will definitely be ordering again.",
  },
  {
    id: 4,
    username: "Mike L.",
    rating: 5,
    text: "The orange chicken is out of this world! Crispy, juicy, and the sauce is a perfect blend of sweet and tangy.",
  },
  {
    id: 5,
    username: "Jessica R.",
    rating: 4,
    text: "Great vegetarian options! The vegetable lo mein was a delicious and satisfying meal. I'll be back for sure.",
  },
  {
    id: 6,
    username: "David T.",
    rating: 5,
    text: "I love the Beef with Broccoli here. The beef is tender and the broccoli is crisp. A classic done perfectly.",
  },
  {
    id: 7,
    username: "Olivia W.",
    rating: 5,
    text: "My go-to spot for Chinese food in Toronto. The quality is always consistent, and the food is always a treat.",
  },
  {
    id: 8,
    username: "Chris P.",
    rating: 4,
    text: "Ordered for a family gathering, and everyone was impressed. The variety and flavors were outstanding!",
  },
  {
    id: 9,
    username: "Nancy S.",
    rating: 5,
    text: "The Crab Rangoon is a must-try. So light and crispy. It's the perfect appetizer.",
  },
];

function StarRating({ rating }) {
  const stars = Array.from({ length: 5 }, (_, index) => (
    <span key={index} className={`text-yellow-500 ${index < rating ? 'fill-current' : 'text-gray-600'}`}>
      ⭐
    </span>
  ));
    ...
    <main className="bg-gray-900 text-gray-300 min-h-screen">
      ...
      <section className="relative py-24 md:py-32 lg:py-40 overflow-hidden">
        ...
        <div className="container mx-auto text-center relative z-10">
          ...
          >
            <Link href="/Menu" className="bg-red-600 hover:bg-red-500 text-white font-bold py-3 px-6 rounded-full text-lg transition-all duration-300 shadow-lg hover:shadow-2xl hover:scale-105">
              Order Now
            </Link>
          </motion.div>
        </div>
          ...
          <div className="relative overflow-hidden w-full">
            ...
            >
              <AnimatePresence mode="popLayout">
                {testimonials.slice(currentReviewIndex, currentReviewIndex + 3).map((review) => (
                  <motion.div
                    key={review.id}
                  ...
                  >
                    <div className="flex items-center mb-2">
                      ...
                      <h4 className="text-lg font-semibold text-gray-300 mr-4">{review.username}</h4>
                      <StarRating rating={review.rating} />
                    </div>
                    <p className="text-gray-300 italic mb-4 font-body">"{review.text}"</p>
                  </motion.div>
                ))}
              </AnimatePresence>
            </motion.div>
      ...
      <section className="py-16 md:py-24 bg-gray-800 relative overflow-hidden">
        ...
        <div className="container mx-auto text-center relative z-10 p-8 rounded-lg">
          ...
          >
            <Link href="/Menu" className="bg-red-600 hover:bg-red-500 text-white font-bold py-4 px-8 rounded-full text-lg transition-all duration-300 shadow-lg hover:shadow-2xl hover:scale-105">
              View Our Menu & Order
            </Link>
          </motion.div>
        </div>
      ...
      <footer className="bg-gray-900 py-8 text-center text-gray-400 text-sm">
        <div className="container mx-auto">
          <p className="font-body">&copy; {new Date().getFullYear()} Firewook Toronto. All rights reserved.</p>
